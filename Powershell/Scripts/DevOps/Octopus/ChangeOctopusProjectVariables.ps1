...
ForEach ($variable in $variableSet) {	
    ...
    If ($variableScope -like $testEnvironmentID) {
		...
		Write-Information "[ChangeOctopusProjectVariables.ps1] Changing Value for Variable $variableName , AllHires Test..."
     ...
     If ($variableScope -like $prodEnvironmentID) {
		...
		Write-Information "[ChangeOctopusProjectVariables.ps1] Changing Value for Variable $variableName , AllHires Prod..."
...
ForEach ($variable in $variableSet) {	
	...
	If ($variableValue -like "*cov*") {
		...
		Write-Information "[ChangeOctopusProjectVariables.ps1] Changing Value for Variable $variableName..."
